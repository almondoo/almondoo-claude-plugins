...
- Multiple independent auditors converge on the **real** defects: 5+ of 9 flagging the same thing is unlikely to be coincidence.
- One-off findings (1-2 of 9) are filtered out as noise — so don't suppress your judgment to avoid false positives. Flag what you see.
